...
public class QueueArray_2511533007 {
	int front_3007, rear_3007, size_3007;
	int capacity_3007;
	int array_3007[];
	
	public QueueArray_2511533007(int capacity_3007) {
		this.capacity_3007 = capacity_3007;
		front_3007 = this.size_3007 = 0;
		rear_3007 = capacity_3007 - 1;
		array_3007 = new int [this.capacity_3007];
	}
	
	boolean isFull_3007(QueueArray_2511533007 queue_3007) {
		return (queue_3007.size_3007 == queue_3007.capacity_3007);
	}
	
	boolean isEmpty_3007(QueueArray_2511533007 queue_3007) {
	...
	void enqueue_3007(int item_3007 ) {
		if (isFull_3007(this))
			return;
		this.rear_3007 = (this.rear_3007 + 1) % this.capacity_3007;
	...
	int dequeue_3007() {
		...
		this.front_3007 = (this.front_3007 + 1) % this.capacity_3007;
		this.size_3007 = this.size_3007 - 1;
		return item_3007;
	}
	int front_3007() {
